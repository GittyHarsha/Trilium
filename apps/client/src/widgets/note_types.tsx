 ...
 */
export type ExtendedNoteType = Exclude<NoteType, "launcher" | "text" | "code"> | "empty" | "readOnlyCode" | "readOnlyText" | "editableText" | "editableCode" | "attachmentDetail" | "attachmentList" |  "protectedSession" | "aiChat" | "copilotCanvas" | "sqlConsole";
...
export const TYPE_MAPPINGS: Record<ExtendedNoteType, NoteTypeMapping> = {
    ...
    copilotCanvas: {
        view: () => import("./type_widgets/CopilotCanvas"),
        className: "copilot-canvas-widget-container",
        isFullHeight: true
    },
    sqlConsole: {
