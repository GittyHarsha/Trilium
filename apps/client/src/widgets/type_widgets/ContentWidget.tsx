...
import CopilotSettings from "./options/copilot_settings";
...
export type OptionPages = "_optionsAppearance" | "_optionsShortcuts" | "_optionsTextNotes" | "_optionsCodeNotes" | "_optionsImages" | "_optionsSpellcheck" | "_optionsPassword" | "_optionsMFA" | "_optionsEtapi" | "_optionsBackup" | "_optionsSync" | "_optionsAi" | "_optionsCopilot" | "_optionsOther" | "_optionsLocalization" | "_optionsAdvanced";
...
const CONTENT_WIDGETS: Record<OptionPages | "_backendLog", (props: TypeWidgetProps) => JSX.Element> = {
    ...
    _optionsCopilot: CopilotSettings,
